		...
		if ( ! this.verifyParameterDateIsRightWithoutHistory(dateString)) {
			...
			return this
					.generateResponseATerritoireByCode(
							sparqlUtils
							.executeSparqlQuery(
									GeoQueries.getZoneEmploiByCodeAndDate(code, this.formatValidParameterDateIfIsNull(dateString))),
							header,
		   ...
		   if (date != null){
	        ...
	        if ( ! this.verifyParameterDateIsRightWithHistory(dateString)) {
	            ...
	            return this
	                .generateResponseListOfTerritoire(
	                    sparqlUtils
	                        .executeSparqlQuery(GeoQueries.getListZonesEmploi(this.formatValidParameterDateIfIsNull(dateString))),
	                    header,
